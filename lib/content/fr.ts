...
const fr = {
  hero: {
    title: "ConfiAuto",
    subtitle: "Le bouclier anti-arnaque automobile",
    cta: "Découvrir les packs",
  },
  ...
  packs: {
    ...
    items: [
      {
        title: "Pack Amis Mécano",
        price: "100€",
        subtitle: "✔ 105 points de contrôle",
        features: [
      ...
      {
        title: "Pack Amis Courtier",
        price: "À partir de 100€",
        subtitle: "✔ Service complet d’achat",
        features: [
          "🔎 Recherche du véhicule",
          "🤝 Gestion vendeurs",
          "📅 Prise de rendez-vous",
          "🚗 105 points de contrôle",
        ],
        cta: "Être accompagné",
      },
    ],
    ...
    items: [
      {
        ...
        a: "Nous inspectons le véhicule avant achat avec plus de 100 points de contrôle pour éviter toute arnaque.",
      },
      {
        q: "Est-ce que vous vous déplacez ?",
        a: "Oui, nous nous déplaçons selon votre localisation pour inspecter le véhicule directement.",
      },
      {
        q: "Que se passe-t-il si le véhicule a un problème ?",
        a: "Nous vous donnons un rapport clair pour éviter un mauvais achat ou négocier le prix.",
      },
      {
        q: "Combien de temps dure une inspection ?",
        a: "En moyenne entre 1h et 2h selon le véhicule.",
      },
    ],
    more: "Voir toutes les questions",
  },
  ...
  cta: {
    title: "Ne prenez plus de risques inutiles",
    button: "Contacter\nmaintenant",
  },
